	                    ...
	                    <div class="card card-primary card-outline table-responsive">
	                    	<div class="card-body">
								...
								<div class="form-group">
                    				<label>Nombre</label>
									<input type="text" class="form-control basic-usage {{ $errors->has('name') ? 'is-invalid' : ''}}" name="name" id="name" placeholder="Nombre de usuario">
                                ...
                                <div class="form-group">
                    				<label>Email</label>
									<input type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : ''}}" name="email" id="email" placeholder="Correo del usuario">
