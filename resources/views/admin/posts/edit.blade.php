	                    ...
	                    <div class="card card-primary card-outline table-responsive">
	                    	<div class="card-body">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control basic-usage {{ $errors->has('name') ? 'is-invalid' : ''}}" name="name" id="name" value="{{ old('name', $post->name) }}" placeholder="Ingrese aquí el titulo de la publicación">
                    			...
                    			<div class="form-group">
									...
									<input type="text" class="form-control {{ $errors->has('slug') ? 'is-invalid' : ''}}" name="slug" id="permalink" value="{{ old('slug', $post->slug) }}">
								...
								<div class="form-group">
							   	...
							   	<div class="form-group">
									...
									<textarea name="body" class="form-control {{ $errors->has('body') ? 'is-invalid' : ''}}" id="editor" placeholder="Contenido completo de la publicación">{{ old('body',$post->body) }}</textarea>
	                    	...
	                    	<div class="card-body">
	                    		<div class="form-group">
					                ...
					                <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
					                    <input type="text" name="published_at" value="{{ old('published_at', $post->published_at->format('d/m/Y')) }}" class="form-control datetimepicker-input {{ $errors->has('published_at') ? 'is-invalid' : ''}}" data-target="#datetimepicker4"/>
								...
								<div class="form-group">
									...
									@if($post->foto)
										<img id="preview" src="{{ asset('img') }}/{{ $post->foto }}" style="max-width: 100px; margin-top: 20px;">
									@else
	                			...
	                			<div class="form-group">
									...
									<textarea name="excerpt" class="form-control {{ $errors->has('excerpt') ? 'is-invalid' : ''}}" rows="2" placeholder="Extracto de la publicación">{{ old('excerpt', $post->excerpt) }}</textarea>
